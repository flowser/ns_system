     ...
     <footer class="bg-white py-14 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.03] dark:to-transparent lg:py-[100px]">
        <div class="container">
            <div class="grid gap-y-10 gap-x-4 sm:grid-cols-3 lg:grid-cols-5">
                <div class="relative">
                    <img src="assets/themes/plurk/assets/images/logo.png" alt="plurk" class="h-7" />
                    ...
                    <img src="assets/themes/plurk/assets/images/footer-shape.png" alt="footer-shape" class="absolute bottom-0 right-0 sm:left-0" />
                    <img
                        src="assets/themes/plurk/assets/images/footer-shape-dark.png"
