                ...
                <div class="card card-primary card-outline">
                    <form role="form" @submit.prevent="updateHomePage()" >
                        ...
                        <div class="card-body">
                            <div class="row">
                               <div class="col-md-4 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">About Us Image</span>
                                        <span class="info-box-number">
                                            <input @change="ChangeBrandLogo($event), 'about_us_image'" type="file"  class="form-control">
                                            <img :src="updateBrandLogo(pageform.about_us_image, 'about_us_image')" class="info-box-text" alt="" style="width: 200px;" required>
                                        </span>
                                     </div>
                                  </div>
                               </div>
                               <div class="col-md-4 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     <span class="info-box-icon bg-success"><i class="far fa-flag"></i></span>
                                     <div class="info-box-content">
                                        <span class="info-box-text">About Us Title</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.about_us_title" type="text"  class="form-control"
                               ...
                               <div class="col-md-4 col-sm-6 col-12">
                                  <div class="info-box shadow">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">About Us Description</span>
                                        <span class="info-box-number">
                                            <textarea v-model="pageform.about_us_description" type="text"  class="form-control"
                                                :class="{ 'is-invalid': pageform.errors.has() }" required>
                                            </textarea>
                                        </span>
                                     </div>
                            ...
                            <h3 class="mb-2">Count Down</h3>
                            <div class="row">
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     <span class="info-box-icon bg-info"><i class="far fa-envelope"></i></span>
                                     <div class="info-box-content">
                                        <span class="info-box-text">Year In Business</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.business_year" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     ...
                                     <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <input v-model="pageform.team_members" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow">
                                     <span class="info-box-icon bg-warning"><i class="far fa-copy"></i></span>
                                     <div class="info-box-content">
                                        <span class="info-box-text">Happy Clients</span>
                                        <span class="info-box-number">
                                             <input v-model="pageform.happy_clients" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow-lg">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">Projets Done</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.projects_done" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                            ...
                            <div class="row">
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box bg-gradient-info">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">What Makes Us Different Title</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.difference_title" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box bg-gradient-success">
                                     ...
                                     <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <input v-model="pageform.creativity" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box bg-gradient-warning">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">Innovative Thinking</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.innovative_thinking" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box bg-gradient-danger">
                                     ...
                                     <div class="info-box-content">
                                        <span class="info-box-text">Rapid Solutions</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.rapid_solutions" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                            ...
                            <div class="row">
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     <span class="info-box-icon bg-info"><i class="far fa-envelope"></i></span>
                                     <div class="info-box-content">
                                        <span class="info-box-text">Top-Notch Support</span>
                                        <span class="info-box-number">
                                            <input v-model="pageform.top_notch_support" type="text"  class="form-control"
                                            :class="{ 'is-invalid': pageform.errors.has() }" required>
                                        </span>
                                     </div>
                                  </div>
                               ...
                               <div class="col-md-3 col-sm-6 col-12">
                                  <div class="info-box shadow-sm">
                                     <span class="info-box-icon bg-success"><i class="far fa-flag"></i></span>
                                     <div class="info-box-content">
                                        <span class="info-box-text">What Makes Us Different Image</span>
                                        <span class="info-box-number">
                                            <input @change="ChangeBrandLogo($event, 'difference_image')" type="file"  class="form-control">
                                        <img :src="updateBrandLogo(pageform.difference_image, 'difference_image')" alt="" style="width: 200px;" required>
                                        </span>
                                     </div>
                                  </div>
                               </div>
                                    ...
                                    <div class="form-group row" >
                        			    ...
                        			    <div class="col-md-8" >
                                            <div class="form-group">
                                                ...
                                                <input @change="ChangeBrandLogo($event, 'meta_image')" type="file" class="form-control">
                                                <img :src="updateBrandLogo(pageform.meta_image, 'meta_image')" alt="" style="width: 200px;" >
                                            </div>
                                        </div>
                                    </div>
                	    		</div>
        ...
        methods:{
            ...
            ChangeBrandLogo(event, type) {
              ...
              if (file.size > 1048576) {
                ...
                reader.onload = event => {
                   this.pageform.type = event.target.result;
                };
                reader.readAsDataURL(file);
              }
            },
            updateBrandLogo(pageformheader_logo, type) {
                img = this.pageform.type;
              if (img == null) {
