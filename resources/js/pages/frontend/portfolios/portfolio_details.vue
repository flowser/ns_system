<template>
    ...
    <div class="container">
        <div>
            ...
            <div class="overflow-x-auto overflow-y-hidden">
                ...
                >
                    ...
                    <li class="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]"
                    >
                        <div>
        ...
        <div class="grid gap-[30px] sm:grid-cols-2">
            <img
                :src="Loadimage('portfolio-img-1.png')"
                alt="portfolio-img-1"
                class="rounded-[32px]"
                data-aos="fade-up"
                data-aos-duration="1000"
            />
            <img
                :src="Loadimage('portfolio-img-2.png')"
                alt="portfolio-img-2"
                class="rounded-[32px]"
                data-aos="fade-up"
                data-aos-duration="1000"
        ...
        <div class="py-[30px] sm:py-[50px]">
            <img
                :src="Loadimage('portfolio-img-3.png')"
                alt="portfolio-img-3"
                class="rounded-[32px]"
                data-aos="fade-up"
                data-aos-duration="1000"
        ...
        <div>
            <img
                :src="Loadimage('portfolio-img-4.png')"
                alt="portfolio-img-4"
                class="rounded-[32px]"
                data-aos="fade-up"
                data-aos-duration="1000"
...
import Portfolioslider from '../../includes/frontend/slider/portfolioslider.vue'
export default {
