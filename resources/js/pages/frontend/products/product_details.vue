<template>
    ...
    <section class="py-14 lg:py-[100px]">
         <div class="container">
             <div class="heading text-center lg:w-7/12 ltr:lg:text-left rtl:lg:text-right">
             ...
             <div class="grid gap-10 sm:grid-cols-3 sm:gap-7 lg:grid-cols-4">
                 <div>
                     <div class="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                     ...
                     <h4 class="mb-4 text-[22px] font-extrabold text-black dark:text-white">Define</h4>
                     <p class="font-semibold leading-[32px] md:text-lg">We combine our team’s depth of experience in design.</p>
                 </div>
                 <div>
                     <div class="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                         <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                             <g clip-path="url(#clip0_1062_12631)">
                                 <path
                     ...
                     <h4 class="mb-4 text-[22px] font-extrabold text-black dark:text-white">Design</h4>
                     <p class="font-semibold leading-[32px] md:text-lg">Curabitur a libero nec dolor ultricies suscipit.</p>
                 </div>
                 <div>
                     <div class="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                         <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                             <g clip-path="url(#clip0_1062_12706)">
                                 <path
                     ...
                     <h4 class="mb-4 text-[22px] font-extrabold text-black dark:text-white">Build</h4>
                     <p class="font-semibold leading-[32px] md:text-lg">Donec iaculis massa id venenatis ultrices.</p>
                 </div>
                 <div>
                     <div class="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                         <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                             <g clip-path="url(#clip0_1062_12720)">
                                 <path
                     ...
                     <h4 class="mb-4 text-[22px] font-extrabold text-black dark:text-white">Test</h4>
                     <p class="font-semibold leading-[32px] md:text-lg">Proin cursus diam eu nunc aliquet aliquam.</p>
                 </div>
                 <div>
                     <div class="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                         <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <h4 class="mb-4 text-[22px] font-extrabold text-black dark:text-white">Launch</h4>
                     <p class="font-semibold leading-[32px] md:text-lg">Ut vehicula ante at turpis luctus sollicitudin.</p>
                 </div>
             </div>
         </div>
        </section>
         ...
         <div class="container">
             ...
             <ul>
                 <li class="flex border-t-2 border-black/5 py-10 dark:border-gray-dark lg:items-center">
                     ...
                     <div class="lg:w-4/6">
                         <h4 class="pb-3 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Clear and straightforward</h4>
                 ...
                 <li class="flex border-t-2 border-black/5 py-10 dark:border-gray-dark lg:items-center">
                     ...
                     <div class="lg:w-4/6">
                         <h4 class="pb-3 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Visually appealing</h4>
                         <p class="text-lg font-semibold">
                 ...
                 <li class="flex border-t-2 border-black/5 py-10 dark:border-gray-dark lg:items-center">
                     ...
                     <div class="lg:w-4/6">
                         <h4 class="pb-3 text-xl font-extrabold text-black dark:text-white sm:text-2xl">User-friendly</h4>
                         <p class="text-lg font-semibold">
                 ...
                 <li class="flex border-t-2 border-black/5 pt-10 dark:border-gray-dark lg:items-center">
                     ...
                     <div class="lg:w-4/6">
                         <h4 class="pb-3 text-xl font-extrabold text-black dark:text-white sm:text-2xl">Enhanced Productivity</h4>
                         <p class="text-lg font-semibold">
