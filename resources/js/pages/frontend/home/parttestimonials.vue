                            ...
                            <div class="items-center gap-4 sm:grid sm:grid-cols-3">
                                <div class="col-span-2">
                                    <div class="relative rounded-3xl bg-white/[0.02] p-6">
                                        <img
                                            src="assets/themes/plurk/assets/images/blue-quote.png"
                                            alt="blue-quote"
                                ...
                                >
                                    <img src="assets/themes/plurk/assets/images/testimonial.png" alt="testimonial" class="h-full w-full object-cover object-top" />
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="items-center gap-4 sm:grid sm:grid-cols-3">
                                ...
                                <img
                                    src="assets/themes/plurk/assets/images/testimonial.png"
                                    alt="testimonial"
