            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div data-aos="fade-up" data-aos-duration="1000">
                    ...
                    >
                        ...
                        <router-link :to="{name: 'Product Details', params:{product:'1'}}" href="services-detail.html"
                        ...
                        <router-link :to="{name: 'Product Details', params:{product:'1'}}"
