<template>
   <div class="relative my-14 mx-auto border-[10px] border-transparent bg-black py-14 dark:border-black dark:bg-gray-dark lg:my-[100px] lg:py-[100px] xl:max-w-[1440px] xl:rounded-3xl">
        <div class="container">
            <div class="items-end gap-4 lg:flex xl:gap-0">
                <div class="lg:w-1/2">
                    ...
                    <div class="grid gap-x-7 gap-y-12 sm:grid-cols-2" data-aos="fade-right" data-aos-duration="1000">
                ...
                <div class="top-1/2 mx-auto mt-10 ltr:right-5 rtl:left-5 md:w-[45%] lg:mt-0 xl:absolute xl:-translate-y-1/2">
                    <img src="assets/themes/plurk/assets/images/box-img.png" alt="box-img" class="w-full rtl:rotate-y-180" />
                </div>
            </div>
        </div>
    </div>
